...
- matches the released Sol TensorDescriptor/program-id geometry and BF16
  reduction source expression, but the v5 production candidate still uses a
  fixed 8-warps/2-stages launch;
...
PROBE_CONTRACT = "sol-h3-keyless-k1-sol-reduction-probe-v8"
EVIDENCE_CONTRACT = "sol-h3-keyless-k1-sol-reduction-calibration-v8"
...
def main() -> None:
    ...
    result = {
        ...
        "limitations": [
            ...
            "v7 established one-block BF16 route spill/reload parity; v8 sweeps bounded "
            "multi-block chunks but does not freeze a production chunk size",
            "CUDA timing is recorded on the frozen tail geometry for each early/mid/late block",
