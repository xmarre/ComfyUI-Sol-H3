...
- breaks the RMS-reduction-to-route graph through a small FP32 [T,H] scratch
  and retests the unchanged route reduction;
...
PROBE_CONTRACT = "sol-h3-keyless-k1-sol-reduction-probe-v6"
EVIDENCE_CONTRACT = "sol-h3-keyless-k1-sol-reduction-calibration-v6"
...
def main() -> None:
    ...
    result = {
        ...
        "limitations": [
            ...
            "the split-RMS [T,H] FP32 scratch is diagnostic only and is not a production "
            "memory contract",
