...
- records the authoritative released reducer's autotuned launch configuration
  and sweeps the released 4/8-warp x 1..4-stage matrix for RC;
...
PROBE_CONTRACT = "sol-h3-keyless-k1-sol-reduction-probe-v5"
EVIDENCE_CONTRACT = "sol-h3-keyless-k1-sol-reduction-calibration-v5"
...
def main() -> None:
    ...
    result = {
        ...
        "limitations": [
            ...
            "the released-Sol 4/8-warp x 1..4-stage launch matrix is diagnostic only; "
            "no production config policy is selected by this probe",
