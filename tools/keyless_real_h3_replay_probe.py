...
PROBE_CONTRACT = "sol-h3-keyless-fp32-rope-isolation-v3"
...
def main() -> None:
    ...
    result = {
        ...
        "limitations": [
            ...
            "FP32-RoPE isolation tests comfy-kitchen CUDA fused ComputeType=float semantics without changing production K1/K2 arithmetic",
        ],
    }
    if args.output_json:
