...
def test_k1_sol_reduction_probe_contracts_are_versioned():
    ...
    assert 'PROBE_CONTRACT = "sol-h3-keyless-k1-sol-reduction-probe-v8"' in source
    assert (
...
def test_k1_sol_reduction_probe_sweeps_bounded_spill_chunk_sizes_and_timing():
    source = _probe_source()
    ...
    assert '"prior_k1_v7_bounded_spill_sha256"' in source
