...
class SolH3KeylessRealH3Replay:
    ...
    DESCRIPTION = (
        ...
        "ComfyUI/output/keyless_real_h3_replay_reports and returned as text. Frozen-envelope "
        "failure remains recorded in JSON and does not abort this diagnostic output node."
    )
