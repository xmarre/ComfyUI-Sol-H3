...
@triton.jit(do_not_specialize=["N", "HS", "ROW"])
def affine_kernel(H, SHIFT, SCALE, INDEX, N, WIDTH: tl.constexpr,
                  HS, SS: tl.constexpr, SC: tl.constexpr,
                  CS: tl.constexpr, CC: tl.constexpr, ROW,
