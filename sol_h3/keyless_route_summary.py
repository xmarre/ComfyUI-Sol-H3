...
def route_centroid_split_rms_diagnostic(
    ...
    TensorDescriptor tile and three-dimensional program geometry while writing
    only the exact current per-row/head inverse RMS into [T,H] FP32 storage.
    The second kernel reloads that scalar,
